...
| [ksaga115/KabuBattle](https://github.com/ksaga115/KabuBattle) | **株バトル**（日本株の決算＝素体・株価＝状態・事業＝技でキャラを作り、コードバトルのエンジンで戦わせる）。別リポジトリで開発・運用。エンジンは本リポジトリの `BarcodeTool.html` を固定コミットから抽出して使う |
